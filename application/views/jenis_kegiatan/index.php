    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?= base_url('admin/jenis-kegiatan/form') ?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <?php foreach ($data as $key => $value) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('admin/jenis-kegiatan/form/'.$value->id) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                    <a href="<?= base_url('admin/jenis-kegiatan/delete/'.$value->id) ?>" onclick="return confirm('Yakin ingin menghapus data?')" class="btn btn-danger"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
